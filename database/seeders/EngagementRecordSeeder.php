...
class EngagementRecordSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $records = [
            ['user' => 'student.volunteer@plp.edu.ph', 'project' => 'e-Kaalaman: Community Digital Skills Training', 'community' => 'PSG-SM-001', 'title' => 'e-Kaalaman Digital Literacy Workshop', 'type' => 'service_learning', 'role' => 'Digital mentor', 'date' => '2025-09-27', 'hours' => 24, 'sdg' => 'sdg_4', 'description' => 'Facilitated small-group smartphone productivity, online safety, and e-government portal exercises.', 'source' => 'project_roster', 'status' => 'approved', 'encoder' => 'coordinator@plp.edu.ph'],
            ['user' => 'joshua.reyes@plp.edu.ph', 'project' => 'e-Kaalaman: Community Digital Skills Training', 'community' => 'PSG-SM-001', 'title' => 'e-Kaalaman Digital Literacy Workshop', 'type' => 'service_learning', 'role' => 'Technical facilitator', 'date' => '2025-09-27', 'hours' => 28, 'sdg' => 'sdg_4', 'description' => 'Prepared training devices and guided residents through digital payments and online account security.', 'source' => 'project_roster', 'status' => 'approved', 'encoder' => 'coordinator@plp.edu.ph'],
            ['user' => 'coordinator@plp.edu.ph', 'project' => 'e-Kaalaman: Community Digital Skills Training', 'community' => 'PSG-SM-001', 'title' => 'e-Kaalaman Digital Literacy Workshop', 'type' => 'extension', 'role' => 'Project coordinator', 'date' => '2025-09-27', 'hours' => 36, 'sdg' => 'sdg_10', 'description' => 'Coordinated partner meetings, training delivery, volunteer deployment, and accomplishment documentation.', 'source' => 'project_roster', 'status' => 'approved', 'encoder' => 'coordinator@plp.edu.ph'],
            ['user' => 'angela.mercado@plp.edu.ph', 'project' => 'Healthy Families: Preventive Care and Nutrition Caravan', 'community' => 'PSG-PB-002', 'title' => 'Healthy Families Community Health Caravan', 'type' => 'service_learning', 'role' => 'Student health volunteer', 'date' => '2026-02-15', 'hours' => 18, 'sdg' => 'sdg_3', 'description' => 'Assisted with registration, vital-sign screening, health education, and referral documentation.', 'source' => 'project_roster', 'status' => 'approved', 'encoder' => 'calo.admin@plp.edu.ph'],
            ['user' => 'student.volunteer@plp.edu.ph', 'project' => 'Healthy Families: Preventive Care and Nutrition Caravan', 'community' => 'PSG-PB-002', 'title' => 'Healthy Families Community Health Caravan', 'type' => 'volunteerism', 'role' => 'Registration volunteer', 'date' => '2026-02-15', 'hours' => 14, 'sdg' => 'sdg_3', 'description' => 'Managed beneficiary registration, queue coordination, and distribution of health-learning materials.', 'source' => 'project_roster', 'status' => 'approved', 'encoder' => 'calo.admin@plp.edu.ph'],
            ['user' => 'faculty.extension@plp.edu.ph', 'project' => 'Healthy Families: Preventive Care and Nutrition Caravan', 'community' => 'PSG-PB-002', 'title' => 'Healthy Families Community Health Caravan', 'type' => 'extension', 'role' => 'Faculty project lead', 'date' => '2026-02-15', 'hours' => 30, 'sdg' => 'sdg_3', 'description' => 'Led program planning, coordinated local health personnel, supervised student volunteers, and reviewed outcomes.', 'source' => 'project_roster', 'status' => 'approved', 'encoder' => 'calo.admin@plp.edu.ph'],
            ['user' => 'community.partner@example.org', 'project' => 'Healthy Families: Preventive Care and Nutrition Caravan', 'community' => 'PSG-PB-002', 'title' => 'Community Mobilization for Healthy Families', 'type' => 'outreach', 'role' => 'Community partner coordinator', 'date' => '2026-02-15', 'hours' => 20, 'sdg' => 'sdg_17', 'description' => 'Mobilized residents, coordinated the venue, and supported referrals with barangay health workers.', 'source' => 'project_roster', 'status' => 'approved', 'encoder' => 'calo.admin@plp.edu.ph'],
            ['user' => 'alumni.partner@plp.edu.ph', 'project' => null, 'community' => 'PSG-KL-005', 'title' => 'Microenterprise Mentoring Orientation', 'type' => 'training', 'role' => 'Volunteer business mentor', 'date' => '2026-07-26', 'hours' => 6, 'sdg' => 'sdg_8', 'description' => 'Completed mentor orientation and prepared sample costing and recordkeeping exercises for community entrepreneurs.', 'source' => 'manual', 'status' => 'submitted', 'encoder' => 'calo.admin@plp.edu.ph'],
            ['user' => 'project.proponent@plp.edu.ph', 'project' => null, 'community' => 'PSG-ST-004', 'title' => 'Youth Reading Program Consultation', 'type' => 'outreach', 'role' => 'Faculty facilitator', 'date' => '2026-07-18', 'hours' => 5, 'sdg' => 'sdg_4', 'description' => 'Conducted initial consultation with youth leaders for a proposed reading and learning support project.', 'source' => 'manual', 'status' => 'rejected', 'encoder' => 'project.proponent@plp.edu.ph', 'remarks' => 'Please attach the final attendance list and confirm the consultation duration before resubmission.'],
            ['user' => 'joshua.reyes@plp.edu.ph', 'project' => null, 'community' => 'PSG-MG-003', 'title' => 'Community Emergency Response Orientation', 'type' => 'training', 'role' => 'Student participant', 'date' => '2026-06-20', 'hours' => 8, 'sdg' => 'sdg_11', 'description' => 'Participated in basic disaster preparedness, emergency communication, and household evacuation planning.', 'source' => 'manual', 'status' => 'draft', 'encoder' => 'coordinator@plp.edu.ph'],
        ];
