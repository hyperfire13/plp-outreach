...
async function reviewNeed(row, decision) {
    const remarks =
        decision === "reject" ? window.prompt("Reason for rejection:") : null;
    ...
    try {
        ...
        failure.value =
            error.response?.data?.message || "Unable to review priority need.";
    }
}
            ...
            <div class="container-fluid">
                <div class="mb-3">
                    ...
                    <p class="text-muted mb-0">
                        Review the highest-priority community needs from
                        submitted surveys.
                    </p>
                </div>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Description</th>
                                        <th>Status</th>
                                        <th v-if="canReview" class="text-end">
                                            Actions
                                        </th>
                                    </tr>
                                </thead>
